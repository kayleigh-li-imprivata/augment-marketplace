...
2. **Execute the resolution:**
   ...
   - Present exact `git` commands for the user to commit and push themselves
   - Present draft GitHub replies for the user to post themselves
...
3. **Never skip:**
   ...
   - Running tests before applying changes
   - Asking for approval before applying changes
   - ❌ **NEVER commit, push, or post/reply to GitHub** — always hand off commands and drafts to the user
